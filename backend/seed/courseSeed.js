...
const seedCourses = async () => {
  try {
    ...
    const alexander = await User.findOne({ email: "alexander@gmail.com" });
    const sophia = await User.findOne({ email: "sophia@gmail.com" });
    const lucas = await User.findOne({ email: "lucas@gmail.com" });
    const isabella = await User.findOne({ email: "isabella@gmail.com" });
    const liam = await User.findOne({ email: "liam@gmail.com" });
    const emily = await User.findOne({ email: "emily@gmail.com" });
    ...
    const courses = [
      {
        ...
        glossary: [
          ...
          },
          {
            term: "Middleware",
            definition:
              "Functions that execute during request handling in Express",
          },
          {
            term: "CI/CD",
        ...
        certificates: [
          {
            ...
            certificateImage:
              "/uploads/certificates/datascience_certificate.jpg",
          },
        ],
        projects: [
          {
