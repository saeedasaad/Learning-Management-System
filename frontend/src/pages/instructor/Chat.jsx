...
export default function InstructorChat() {
  const [messages, setMessages] = useState([
    { id: 1, sender: "student", text: "Sir, when is the next lecture?", reply: "Tomorrow at 10 AM." },
    { id: 2, sender: "student", text: "Can you explain question 3?", reply: "" },
  ]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 border rounded p-4 h-80 overflow-y-auto">
          ...
          {messages.map((msg) => (
            ...
            >
              ...
              {msg.reply && (
                <p className="text-green-600 text-sm mt-1">Reply: {msg.reply}</p>
              )}
            </div>
          ))}
        </div>
        ...
        <div className="bg-white border rounded p-4">
          ...
          {selectedMessage ? (
            ...
            <p className="text-gray-500">Select a student message to reply.</p>
          )}
        </div>
      </div>
    </DashboardCard>
